...
function Item({ item, todos, setTodos }) {
    ...
    const completeTodo = () => {
        setTodos((prevTodos) => prevTodos.map((todo) => todo.id === item.id ? { ...todo, is_completed: !todo.is_completed } : todo ));
    ...
    const handleInputSubmit = (event) => {
        ...
        const updatedTodo = JSON.stringify(todos);
    ...
    const handleDelete = () => {
        setTodos((prevTodods) => prevTodods.filter((todo) => todo.id !== item.id));
